...
class MenuView:
    ...
    def _build_order_panel(self):
        ...
        self.add_person_btn = tk.Button(
            ...
            #relief=tk.FLAT, cursor="hand2", padx=10, # Fixed: Removed fixed width=3 and added padx=10 for dynamic resizing #from main from screen
    ...
    def _handle_responsiveness(self, event) -> None:
